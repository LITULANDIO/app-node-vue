<template>
    <div  v-if="showSettings" class="container-icon" @click="onGoProgile">
...
const onGoProgile = () => {
    navigateTo(`/dashboard/user/my-profile`)
}
const showSettings = computed(() => {
  const pathName = ['/dashboard/user/my-profile', '/', '/register']
